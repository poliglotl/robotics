/*
 * 12_car_ap_open - робот САМ раздаёт Wi-Fi, устройство подключается к нему.
 *
 * Точка доступа БЕЗ ПАРОЛЯ и БЕЗ сканирования эфира: только softAP,
 * фиксированный канал, никаких переключений режима.
 *
 ...
 * Колёса вывесить, антенна прикручена.
 */
