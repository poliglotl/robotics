// ======================================================================
//   СЕТЬ, К КОТОРОЙ ПОДКЛЮЧАЕТСЯ РОБОТ. Сейчас настроено на хотспот
//   телефона с именем "Robot" БЕЗ ПАРОЛЯ (Security: None, 2.4 GHz).
//   Имя должно совпадать буква в букву. Пароль - пустые кавычки.
// ======================================================================
